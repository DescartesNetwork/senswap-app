...
export const setWallet = (wallet) => {
  return async dispatch => {
    ...
    try {
      ...
      const farmingPromgramId = ssjs.fromAddress(farmingAddress);
      const stakePoolAccounts = await connection.getProgramAccounts(farmingPromgramId, {
      ...
      data.stakes = stakePoolAccounts.map((acc) => acc.pubkey.toBase58());
